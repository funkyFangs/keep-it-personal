...
public abstract class KeepItPersonalCommand implements Command<CommandSourceStack> {
    ...
    public int run(CommandContext<CommandSourceStack> context) {
        ...
        if (player instanceof DeathPreferenceContainer container) {
            ...
            source.sendFailure(Component.literal(ERROR_RESPONSE));
            return SINGLE_ERROR;
        }
    }

    public abstract Integer run(CommandContext<CommandSourceStack> context, DeathPreferenceContainer container);
}
